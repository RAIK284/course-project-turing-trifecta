...
const AuthenticatedLandingPage: React.FC = () => (
  ...
  <div className="w-1/3 my-auto space-y-4 flex flex-col items-center">
    <div className="w-full text-center">
      <text className="text-2xl font-regular text-center" style={{ textShadow: '0 0 10px #00ff00' }}>JOIN SESSION</text>
    ...
    <div className="w-full">
      <button className="w-full h-10 p-2 bg-target-2 rounded-lg text-white text-center">CREATE SESSION</button>
      <div className="absolute bottom-5 left-5">
      <button className="w-full h-10 p-2 bg-target-3 rounded-lg text-white text-center">RULES PAGE</button>
    </div>
  </div>
</div>
</div>
