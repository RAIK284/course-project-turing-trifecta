    ...
    public static async Task SeedData(DataContext context, UserManager<User> userManager)
    {
        ...
        if (!userManager.Users.Any())
        {
            var users = new List<User>
            {
                ...
                {
                    Id = Id_User_Peyton,
                    UserId = Guid.Parse(Id_User_Peyton),
                ...
                {
                    Id = Id_User_Nathan,
                    UserId = Guid.Parse(Id_User_Nathan),
                ...
                {
                    Id = Id_User_Jake,
                    UserId = Guid.Parse(Id_User_Jake),
                ...
                {
                    Id = Id_User_Harith,
                    UserId = Guid.Parse(Id_User_Harith),
                ...
                {
                    Id = Id_User_Kevin,
                    UserId = Guid.Parse(Id_User_Kevin),
